  ...
  <body>
      ...
      <main class="mdl-layout__content mdl-color--grey-100">
		...
		<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp" style="margin:auto;" width="70%">
			<thead>
    			<tr>
      				<th class="mdl-data-table__cell--non-numeric">Ponto</th>
    ...
    <a href="${linkTo[PontoDeAtendimentoController].associar}" id="view-source" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored mdl-color-text--white">Associar</a>
