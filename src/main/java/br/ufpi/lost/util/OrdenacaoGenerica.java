 ...
 */
public class OrdenacaoGenerica<T> implements Comparator<T> {
	 ...
	 */
	public OrdenacaoGenerica(String sortField, SortType sortType) {
	...
	public static <T> void sortList(List<T> list, String sortField, SortType sortType) {
		OrdenacaoGenerica<T> comparator = new OrdenacaoGenerica<T>(sortField, sortType);
		if(list != null) {
